        ...
        } >
        {
            ({ values, resetForm, touched, errors, isSubmitting }) => {
                return ( <
                    ...
                    asterisk invalid = { errors.status && touched.status }
                    errorMessage = { errors.status } >
                    <
                    Field name = "status" > {
                        ({ field, form }) => ( <
                            Radio.Group value = { values.status }
                            onChange = {
                                (val) =>
                                form.setFieldValue(
                                    field.name,
                    ...
                    asterisk invalid = { errors.select && touched.select }
